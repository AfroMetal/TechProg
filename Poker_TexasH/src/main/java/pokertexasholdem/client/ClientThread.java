...
public class ClientThread implements Runnable {
    ...
    protected void listenSocket() throws NullPointerException, IOException {
    ...
    protected void onMessage() {
        ...
        if (message.startsWith("NOWACT")) {
            ...
            clientWindow.getSpinnerBetRaise()
                    .setModel(new SpinnerNumberModel(new Integer(minBet), new Integer(minBet), null, new Integer(5)));
        ...
        if (message.startsWith("CARDPLAYER")) {
            // parts[0] = "Player#" parts[1] = <rank><suit> parts[2] =
            // <rank><suit>
