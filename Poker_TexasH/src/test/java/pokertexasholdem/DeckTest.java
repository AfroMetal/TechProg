...
public class DeckTest {
	...
	/*
	 * @Test public void testDealCardsFromDeck() { //if the 1st card from fresh
	 * deck is the 1st dealt card firstCard = deck.getDeckList().get(0); deal1 =
	 * deck.dealCardsFromDeck(1); deal2 = deck.dealCardsFromDeck(1); assertSame(
	 * firstCard, deal1[0] ); //if String representations of this cards match
	 * assertEquals( firstCard.toString(), deal1[0].toString() ); //if the 1st
	 * and 2nd dealt cards differ //(card is really removed from deck after
	 * deal) assertNotSame( deal1, deal2 ); //if 1st and 2nd dealt cards String
	 * representations differ assertNotEquals( deal1[0].toString(),
	 * deal2[0].toString() );
	 * 
	 * }
	 */
