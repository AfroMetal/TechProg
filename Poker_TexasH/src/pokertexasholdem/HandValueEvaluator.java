...
public class HandValueEvaluator {
    ...
    //allows to add Board cards and Player cards to make 7 cards array to evaluate
    ...
    /**
     * Method sets evaluatedValue to High Card as it is only triggered when no other Special Value was found.
     * ratings[0] is set to High Card rate and ratings[1-5] are 5 highest card's rates sorted high to low.
     */
    ...
    public boolean isFullHouse() {
        for( int i=0; i<=4; i++ ) {
            ...
            if( tripletFirstCardRate == tripletSecondCardRate && 
                tripletSecondCardRate == tripletThirdCardRate
                ) {
